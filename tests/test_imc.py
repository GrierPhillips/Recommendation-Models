...
from src.imc import IMC, _fh, _fh_hess, _fh_prime, _fw, _fw_hess, _fw_prime
...
class IMCTest(unittest.TestCase):
    ...
    def test_fh(self):
        ...
        actual_0 = _fh(self.input_h, *self.args_h[0])
        self.assertEqual(
            expected_0,
            actual_0,
        ...
        actual_1 = _fh(self.input_h, *self.args_h[1])
        self.assertEqual(
            expected_1,
            actual_1,
        ...
        actual_2 = _fh(self.input_h, *self.args_h[0.5])
        self.assertEqual(
            expected_2,
            actual_2,
    ...
    def test_fh_prime(self):
        ...
        actual_0 = _fh_prime(self.input_h, *self.args_h[0])
        ...
        actual_1 = _fh_prime(self.input_h, *self.args_h[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
        ...
        actual_2 = _fh_prime(self.input_h, *self.args_h[0.5])
        np.testing.assert_allclose(
            expected_2,
            actual_2,
    ...
    def test_fh_hess(self):
        ...
        hess_p = np.arange(8)
        actual_0 = _fh_hess(self.input_h, hess_p, *self.args_h[0])
        np.testing.assert_array_equal(
            expected_0,
            actual_0,
            err_msg='Expected {}, but found {}.'.format(expected_0, actual_0)
        ...
        actual_1 = _fh_hess(self.input_h, hess_p, *self.args_h[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
            err_msg='Expected {}, but found {}.'.format(expected_1, actual_1)
        ...
        actual_2 = _fh_hess(self.input_h, hess_p, *self.args_h[0.5])
        np.testing.assert_array_equal(
            expected_2,
            actual_2,
            err_msg='Expected {}, but found {}.'.format(expected_2, actual_2)
    ...
    def test_fw(self):
        ...
        expected_0 = 13063724.476444978
        actual_0 = _fw(self.input_w, *self.args_w[0])
        self.assertEqual(
            expected_0,
            actual_0,
            msg='Expected {}, but found {}.'.format(expected_0, actual_0)
        ...
        expected_1 = 13063724.84
        actual_1 = _fw(self.input_w, *self.args_w[1])
        self.assertEqual(
            expected_1,
            actual_1,
            msg='Expected {}, but found {}.'.format(expected_1, actual_1)
        ...
        expected_2 = 13063724.658222489
        actual_2 = _fw(self.input_w, *self.args_w[0.5])
        self.assertEqual(
            expected_2,
            actual_2,
            msg='Expected {}, but found {}.'.format(expected_2, actual_2)
    ...
    def test_fw_prime(self):
        ...
        actual_0 = _fw_prime(self.input_w, *self.args_w[0])
        np.testing.assert_array_equal(
            expected_0,
            actual_0,
            err_msg='Expected {}, but found {}.'.format(expected_0, actual_0)
        ...
        actual_1 = _fw_prime(self.input_w, *self.args_w[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
            err_msg='Expected {}, but found {}.'.format(expected_1, actual_1)
        ...
        actual_2 = _fw_prime(self.input_w, *self.args_w[0.5])
        np.testing.assert_allclose(
            expected_2,
            actual_2,
            err_msg='Expected {}, but found {}.'.format(expected_2, actual_2)
    ...
    def test_fw_hess(self):
        ...
        hess_p = np.arange(6)
        actual_0 = _fw_hess(self.input_w, hess_p, *self.args_w[0])
        np.testing.assert_array_equal(
            expected_0,
            actual_0,
            err_msg='Expected {}, but found {}.'.format(expected_0, actual_0)
        ...
        actual_1 = _fw_hess(self.input_w, hess_p, *self.args_w[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
            err_msg='Expected {}, but found {}.'.format(expected_1, actual_1)
        ...
        actual_2 = _fw_hess(self.input_w, hess_p, *self.args_w[0.5])
        np.testing.assert_array_equal(
            expected_2,
            actual_2,
            err_msg='Expected {}, but found {}.'.format(expected_2, actual_2)
