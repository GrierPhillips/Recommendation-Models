...
class IMCTest(unittest.TestCase):
    ...
    def test_fv_prime(self):
        ...
        actual_0 = self.imc0._fv_prime(self.input_v, *self.args_v[0])
        ...
        actual_1 = self.imc1._fv_prime(self.input_v, *self.args_v[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
        ...
        actual_2 = self.imc0_5._fv_prime(self.input_v, *self.args_v[0.5])
    ...
    def test_fv_hess(self):
        ...
        hess_p = np.arange(8)
        actual_0 = self.imc0._fv_hess(self.input_v, hess_p, *self.args_v[0])
        np.testing.assert_array_equal(
            expected_0,
            actual_0,
            err_msg='Expected {}, but found {}.'.format(expected_0, actual_0)
        ...
        actual_1 = self.imc1._fv_hess(self.input_v, hess_p, *self.args_v[1])
        np.testing.assert_array_equal(
            expected_1,
            actual_1,
            err_msg='Expected {}, but found {}.'.format(expected_1, actual_1)
